...
| idNo   | String | N        | 证件号                                                          |
| idNoIssueDate   | String | N        | 证件发行日期(yyyy-MM-dd)                                                            |
...
| photoIdCardFront   | String | N        | 身份证正面 (URL格式)。请调用接口 /order/merchant/file/upload 获取url                                                            |
| photoIdCardBack   | String | N        | 身份证反面 (URL格式)。请调用接口 /order/merchant/file/upload 获取url                                                            |
...
| benLastName           | String | N | 收款人姓。英文字符[2 .. 60 ] 个字符；**CNY币种请填写汉字**                       |
